...
%% Which mask to apply
LargMask =(wg==0).*(bi==0).*(hth==0).*(eyg==0).*(Sr==0);
...
myfunc_Promo = @(a1,a2,a3,a4,a5,a6,a7) a1*wg+a2*bi+a3*hth+a4*hth.*bi;
myfunc_Inhib = @(a1,a2,a3,a4,a5,a6,a7) a5*Sr+a6*eyg.*bi+a7*eyg;
%text for figure title
frmt='%.2f';
text_Promo=@(a1,a2,a3,a4,a5,a6,a7) strcat('Promotes: ',num2str(a1,frmt),' wg +  ',num2str(a2,frmt),'bi + ',num2str(a3,frmt),'hth  + ',num2str(a4,frmt),'hth*bi');
text_Inhib=@(a1,a2,a3,a4,a5,a6,a7) strcat('Inhibits: ',num2str(a5,frmt),' Sr  ',num2str(a6,frmt),'eyg*bi  ',num2str(a7,frmt),'eyg');
...
hFig=figure('Name','Proliferation','Visible', 'on','units','pixel','Position',[300 300 l w]);
...
%txtTitle = uicontrol(hFig,'style','text','Units','normalized','position', [0.01,0.96,0.45,0.05],'String','Promotes Proliferation','Fontsize',14);
mytitle=  @(a1,a2,a3,a4,a5,a6,a7) uicontrol(hFig,'style','text','Units','normalized','position',[0.01,0.95,0.45,0.05],'String',text_Promo(a1,a2,a3,a4,a5,a6,a7),'Fontsize',14);
%txtTitle2 = uicontrol(hFig,'style','text','Units','normalized','position', [0.01,0.86,0.45,0.05],'String','Inhibits Proliferation','Fontsize',14);
mytitle2=  @(a1,a2,a3,a4,a5,a6,a7) uicontrol(hFig,'style','text','Units','normalized','position',[0.01,0.88,0.45,0.05],'String',text_Inhib(a1,a2,a3,a4,a5,a6,a7),'Fontsize',14);

mytitle(0,0,0,0,0,0,0);
mytitle2(0,0,0,0,0,0,0);

% opacity alpha1
slid_blend1 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.50,0.83,0.1,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.1 0.10],'callback' , 'alpha1= get(slid_blend1,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
txtalpha1Title = uicontrol(hFig,'style','text','Units','normalized','position',[0.52,0.94,0.08,0.033],'String','Prolif ');
% opacity alpha2
slid_blend2 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.66,0.83,0.1,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.1 0.10],'callback' , 'alpha2= get(slid_blend2,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid_blend3 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.80,0.83,0.1,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.1 0.10],'callback' , 'alpha3= get(slid_blend3,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid1 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.73,0.22,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.05 0.10],'callback' , 'a1= get(slid1,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid2 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.63,0.22,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.05 0.10],'callback' , 'a2= get(slid2,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid3 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.53,0.22,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.05 0.10],'callback' , 'a3= get(slid3,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid4 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.43,0.22,0.1],'Min' , mins , 'Max' , maxs , ...
    'SliderStep',[0.05 0.10], 'callback' , 'a4= get(slid4,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
txt4Title = uicontrol(hFig,'style','text','Units','normalized','position',[0.80,0.54,0.04,0.04],'String','hth*bi');
%% Inhibits 


%slider 5: Sr
slid5 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.33,0.22,0.1],'Min' , -1 , 'Max' , 0 , ...
    'SliderStep',[0.05 0.10], 'callback' , 'a5= get(slid5,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid6 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.23,0.22,0.1],'Min' , -1 , 'Max' , 0 , ...
    'SliderStep',[0.05 0.10], 'callback' , 'a6= get(slid6,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
slid7 = uicontrol(hFig,'style','slider','Units','normalized','position',  [0.70,0.13,0.22,0.1],'Min' , -1 , 'Max' , 0 , ...
    'SliderStep',[0.05 0.10], 'callback' , 'a7= get(slid7,''value'');ImResult=Modif6(myfunc_Promo(a1,a2,a3,a4,a5,a6,a7),myfunc_Inhib(a1,a2,a3,a4,a5,a6,a7),IndBckgrnd,prolif,alpha1,alpha2,alpha3);mytitle(a1,a2,a3,a4,a5,a6,a7);mytitle2(a1,a2,a3,a4,a5,a6,a7)');
...
txt7Title = uicontrol(hFig,'style','text','Units','normalized','position',[0.80,0.24,0.04,0.04],'String','eyg');
